...
const MAP_QUERY = 'HOTBOX, Москва, Смирновская улица, 25, стр. 3'
const MAP_EMBED_URL = `https://www.google.com/maps?q=${encodeURIComponent(MAP_QUERY)}&z=15&output=embed`
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <Reveal className="mt-8" delay={80}>
          <div className="relative overflow-hidden rounded-[2rem] border border-white/12 bg-white/[0.03] shadow-[0_28px_84px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.08)]">
            ...
            <div className="relative min-h-[360px] overflow-hidden bg-black lg:min-h-[440px]">
              <iframe
                title="Google Maps — HOTBOX, Москва"
                src={MAP_EMBED_URL}
                loading="lazy"
