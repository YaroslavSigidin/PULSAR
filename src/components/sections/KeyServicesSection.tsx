...
const keyServices: KeyService[] = [
  {
    ...
    subtitle: 'Баланс, объём и читаемость трека',
    description:
      'Собираем трек в цельную картину: выстраиваем баланс, пространство и динамику, чтобы каждая партия звучала уверенно и на своём месте.',
    features: [
      'Баланс вокала, бита и музыкальных слоёв',
      'Пространство, глубина и стерео',
      'Чистка артефактов и техническая точность',
      'Микс, готовый к финальному мастерингу',
    ],
  },
  {
    icon: Sparkles,
    ...
    themeClass:
      '[--tariff-top:rgba(24,24,28,0.99)] [--tariff-mid:rgba(15,15,18,0.992)] [--tariff-base:rgba(6,6,8,1)] [--tariff-panel-top:rgba(44,44,50,0.97)] [--tariff-panel-bottom:rgba(16,16,20,0.99)] [--tariff-glow:rgba(255,255,255,0.08)] [--tariff-glow-soft:rgba(255,255,255,0.05)] [--tariff-edge:rgba(255,255,255,0.12)]',
    subtitle: 'Финальный уровень под релиз',
    description:
      'Доводим материал до финального звучания: добавляем плотность, контроль и нужную громкость, чтобы трек уверенно работал на площадках.',
    features: [
      'Финальная тональная и динамическая обработка',
      'Подготовка под стриминги и цифровой релиз',
      'Контроль громкости и цельности звучания',
      'Готовый мастер-файл без лишних компромиссов',
    ],
  },
  {
    icon: Mic2,
    ...
    description:
      'Организуем сессию так, чтобы артист сосредоточился на подаче: помогаем собрать сильный материал и сохранить живую энергию исполнения.',
    features: [
      'Запись вокала в студийной атмосфере',
      'Отбор удачных дублей и тейков',
      'Контроль подачи, интонаций и динамики',
          ...
          <div className="mx-auto mt-3 flex max-w-4xl flex-col items-center gap-4">
            <div className="max-w-3xl">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-white/58 md:text-base">
                Три основные зоны, в которых студия закрывает весь цикл артиста: музыка, релиз и контент
                на продвижение.
              </p>
            </div>
          </div>
